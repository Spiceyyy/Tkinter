...
# Create TExt box Labels
    ...
    save_btn.grid(row=6, column=0, columnspan=2, pady=10, padx=10, ipadx=153)
...
delete_btn.grid(row=10, column=0, columnspan=2, pady=10, padx=10, ipadx=165)

# Create an Edit button
edit_btn = Button(root, text="Edit Record", command=edit)
edit_btn.grid(row=11, column=0, columnspan=2, pady=10, padx=10, ipadx=153)
